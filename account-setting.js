...
    // --- Hàm tiện ích: Đổ dữ liệu vào form (Đã Tối Ưu Hóa) ---
    // --- Hàm tiện ích: Đổ dữ liệu vào form (Tối ưu cho DOB) ---
    function populateInfoForm() {
        if (infoForm) {
            const dobValue = currentUser.dob 
...
                    
                    // Đổ dữ liệu mới nhất vào form (Đã được tối ưu)
                    populateInfoForm(); 
